...
EXECUTE PROCEDURE rg_totalesp('2025-02-26','2025-02-26');
...
SELECT  NVL(impt_nvta,0.00), NVL(impt_nvta / 1.16,0.00), NVL((impt_nvta / 1.16 * 0.16),0.00)
FROM 	nota_vta
WHERE 	fes_nvta >= '2024-02-01' AND fes_nvta <= '2025-02-15' 
			and fol_nvta in (817540,817541,817542,825096,842383,842384,842385,846393,846394,846398,846399,846400,846401,
					846402,846403,846404,846405,846406,846407,846408,846409,846410,846411,846412,846413,846414,
					846415,846416,846417,846418,846419,846420,846421,846422,846423,846424)
       		AND tip_nvta IN('B')
	       	AND edo_nvta = 'A'
	       	AND (aju_nvta IS NULL OR aju_nvta <> 'S');
