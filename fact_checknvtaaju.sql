...
EXECUTE PROCEDURE fact_checknvtaaju('2023-12-28','C');
...
select	*
from	nota_vta
where	fes_nvta >= '2023-09-06' and fes_nvta <= '2023-09-06' and tip_nvta IN('C','D','2','3','4','E','B') and fac_nvta is null 
		and edo_nvta in('A','S')

select	*
from	nota_vta
where	fes_nvta = '2024-01-22' and fac_nvta is not null and tip_nvta IN('C','D','2','3','4') and aju_nvta = 'S'
...
select	*
from	nota_vta
where	edo_nvta = 'A' and fes_nvta = '2023-08-26'
		and tip_nvta = 'B' 	AND (aju_nvta IS NULL OR aju_nvta <> 'S')  AND fac_nvta IS NULL
...
select	*
from	nota_vta
where	edo_nvta = 'A' and fes_nvta = '2024-01-23' AND tip_nvta in('E','B','C','D','2','3','4'	) 	
		AND (aju_nvta IS NULL OR aju_nvta <> 'S')  
		and fac_nvta not in(select fol_fac 
						from factura 
						where fec_fac = '2024-01-23' and tdoc_fac = 'I' and frf_fac is null)
...
where	pla_fac = pla_dfac and fol_fac = fol_dfac and ser_fac = ser_dfac 
		...
		and fes_nvta <> '2024-01-23' and fec_fac = '2024-01-23'
		and frf_fac is null
		
select	*
from	nota_vta
where	edo_nvta = 'A' and fes_nvta = '2023-12-10' AND tip_nvta in('E','B','C','D','2','3','4'	) 	
		--AND (aju_nvta IS NULL OR aju_nvta <> 'S')  
		and fac_nvta is null and fac_nvta not in(select fol_fac 
													from factura 
													where fec_fac = '2023-07-26' and tdoc_fac = 'I')
...
select	*
from	nota_vta 
where   fes_nvta = '2024-01.11' and edo_nvta = 'S' and tpa_nvta = 'C'
		
update	nota_vta
set		edo_nvta = 'A'
where	fes_nvta = '2024-01-06' and edo_nvta = 'S'
...
select	*
from	nota_vta
where	fes_nvta = '2023-12-28' and edo_nvta in('A') 
		and ((impt_nvta - (tlts_nvta * pru_nvta) < -0.01) or  (impt_nvta - (tlts_nvta * pru_nvta) > 0.01))
		and tip_nvta in('C','D','2','3','4', 'E','B')
		
select	*
from	nota_vta
where	fes_nvta = '2023-11-21' and edo_nvta in('A') 
		and fac_nvta is null
		and pru_nvta = 17.54
		AND (aju_nvta IS NULL OR aju_nvta <> 'S')
		and tip_nvta in('C','D','2','3','4')
...
select	fec_fac, count(*)
from	factura
where	fec_fac >= '2023-12-01' and fec_fac <= '2023-12-30' and tdoc_fac = 'I' and tfac_fac = 'S' and faccer_fac = 'N' and frf_fac is null and edo_fac <> 'C' 
group by 1
...
select	count(*)
from	factura
where	fec_fac >= '2023-12-01' and fec_fac <= '2023-12-31' and tdoc_fac = 'I' and tfac_fac = 'S' and faccer_fac = 'N' and frf_fac is null and edo_fac <> 'C' 
...
select	*
from	mov_prc
where	tpr_mprc = '001' and fei_mprc >= '2023-08-01'
order by 	fei_mprc desc		
...
where	tdoc_fac = 'I' and fec_fac = '2023-12-09'  and faccer_fac = 'N'
		...
		and fnvta_dfac in(select fol_nvta from nota_vta 
				where fes_nvta = '2023-12-09' and edo_nvta in('A') and fac_nvta is null
...
SELECT  *
FROM 	nota_vta
WHERE 	fes_nvta = '2023-12-09' AND edo_nvta = 'A' AND (aju_nvta IS NULL OR aju_nvta <> 'S')
		AND impt_nvta = 317.45 and impasi_nvta = 0.00 AND tip_nvta = 'C'
		AND cia_nvta = '15' AND fac_nvta IS NULL AND tpa_nvta = 'E'		
